...
typedef NS_ENUM(NSUInteger, ScringoStyleSheetScreenIdentifier) {
    ...
    /** New Topic View Screen */
    SCRINGO_STYLE_SCREEN_NEW_TOPIC,
    /** New Poll View Screen */
    SCRINGO_STYLE_SCREEN_POLL_CREATE,
    /** Notifications View Screen */
    SCRINGO_STYLE_SCREEN_NOTIFICATIONS
};
...
-(void)customizeChatroomHeaderButtonsView:(UIView *)buttonsView inScreen:(ScringoStyleSheetScreenIdentifier)inScreen;
...
-(void)customizePollCreateTitleTextView:(UITextView *)titleTextView inScreen:(ScringoStyleSheetScreenIdentifier)inScreen;
-(void)customizePollCreateOptionTextView:(UITextField *)optionTextField inScreen:(ScringoStyleSheetScreenIdentifier)inScreen;
-(void)customizePollCreateOptionalOptionTextView:(UITextField *)optionalOptionTextField inScreen:(ScringoStyleSheetScreenIdentifier)inScreen;
