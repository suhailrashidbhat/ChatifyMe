...
/** Retrieve a Chat Room given its topic Id.
 ...
 @param forceClean Force retrieving data from server.
...
+(void)getChatRoomByTopicId:(int)topicId forceClean:(BOOL)forceClean completion:(ScringoGetChatRoomCompletionBlk)completion;
+(void)getChatRoomByObjectId:(NSString *)objectId withObjectType:(NSString *)type withTitle:(NSString *)title withData:(NSString *)data completion:(ScringoGetChatRoomCompletionBlk)completion;
