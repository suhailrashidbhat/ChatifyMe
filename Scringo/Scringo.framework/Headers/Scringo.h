...
#define kScringoUserInteractedNotification          @"kScringoUserInteractedNotification"
#define kScringoPollCreatedSuccessfully             @"kScringoPollCreatedSuccessfully"
...
typedef NS_ENUM(NSUInteger, ScringoFeatureId) {
    ...
    /** Notifications Feature Id */
    SCRINGO_FEATURE_NOTIFICATIONS       = 6
};
...
/** Set Scringo to avoid automatically registering for remote notifications.
 */
+(void)avoidAutomaticallyRegisteringForRemoteNotifications;
...
/** Disable Chat Rooms Handling.
 
 Prevent Scring from automatically fetch and update Chat Rooms.
 */
+(void)disableChatRooms;

/** Enable Flurry usage.
 
 Enable Flurry analyitcs for this app.
 
 @param flurryAppId Flurry App Id.
 @param enableCrashAnalytics Whether to enable Flurry crash analytics or not.
 */
+(void)enableFlurryWithAppId:(NSString *)flurryAppId enableCrashAnalytics:(BOOL)enableCrashAnalytics;

/** Log Application Event.
 
 Uses the predefined framework (like Flurry) to submit applicative events.
 
 @param event The event title.
 @param params The event params, if available. If not, pass nil.
 */
+(void)logAppEvent:(NSString *)event withParams:(NSDictionary *)params;

/** Add Custom Feature to Scringo's Sidebar or Menu.
 
 Add a custom tab to Scringo's Sidebar or Menu. The app still needs to observe the custom button clicked notification to get notified when the tab gets clicked.
 
 @param featureId The Feature Id. This is the Feature Id passed within the custom button clicked notification.
 @param title The tab title.
 @param icon The tab icon.
 */
+(void)addCustomAppFeature:(NSString *)featureId withTitle:(NSString *)title withIcon:(UIImage *)icon;
/** Remove a Custom Feature from Scringo's Sidebar or Menu.
 
 Remove a certain custom tab from Scringo's Sidebar or Menu. Nothing happens if it doesn't exist.
 
 @param featureId The Id of the Feature which tab should be removed.
 */
+(void)removeCustomAppFeature:(NSString *)featureId;
...
/** Tell Scringo to register for remote notifications.
 
 Scringo registers for Alert, Badge and Sound remote notifications. Should be called if app was not registered already.
 */
...
/** Open Scringo's Notifications Screen.

 Open Scringo's Notifications. How it should appear and what type of navigation will it have depends on the given arguments.
 @param navController The navigation controller to which Scringo's Notifications will be pushed. If nil, Scringo's Notifications will present as MODAL.
 @param scringoNavControllerEnabled Whether to enable Scrigno's navigation bar or not.
 */
+(void)openNotificationsWithNavigationController:(UINavigationController *)navController withScringoNavControllerEnabled:(BOOL)scringoNavControllerEnabled;
/** Open Scringo's Poll Creation Screen.

 Open Scringo's Poll Creation Screen. It is always opened as a MODAL.
 @param isEditorial Whether the poll is an editorial one or not.
 */
+(void)openCreatePollAsEditorial:(BOOL)isEditorial;
/** Open Scringo's Chat Room Creation Screen.

 Open Scringo's Chat Room Creation Screen. It is always opened as a MODAL.
 */
+(void)openCreateChatRoom;
/** Direct the user to the App page on the App Store for review.
 */
+(void)openRateApp;
...
/** Open a certain Scringo Image Chat Room.

 Open a certain Scringo Image Chat Room. How it should appear and what type of navigation will it have depends on the given arguments.
 The chat Room will be created if it doesn't exist already.
 @param imageUrl The URL of the Image to open the Chat Room with.
 @param title The title to show in the Chat Rooom. Will be used only if chat room doesn't already exist.
 @param navController The navigation controller to which Scringo's Chat Room will be pushed. If nil, Scringo's Chat Room will present as MODAL.
 @param scringoNavControllerEnabled Whether to enable Scrigno's navigation bar or not.
 @see getChatRoomTopics
 */
+(void)openChatRoomWithImage:(NSString *)imageUrl withTitle:(NSString *)title withNavigationController:(UINavigationController *)navController withScringoNavControllerEnabled:(BOOL)scringoNavControllerEnabled;
/** Open a certain Scringo Video Chat Room.

 Open a certain Scringo Video Chat Room. How it should appear and what type of navigation will it have depends on the given arguments.
 The chat Room will be created if it doesn't exist already.
 @param videoUrl The URL of the Video to open the Chat Room with.
 @param title The title to show in the Chat Rooom. Will be used only if chat room doesn't already exist.
 @param navController The navigation controller to which Scringo's Chat Room will be pushed. If nil, Scringo's Chat Room will present as MODAL.
 @param scringoNavControllerEnabled Whether to enable Scrigno's navigation bar or not.
 @see getChatRoomTopics
 */
+(void)openChatRoomWithVideo:(NSString *)videoUrl withTitle:(NSString *)title withNavigationController:(UINavigationController *)navController withScringoNavControllerEnabled:(BOOL)scringoNavControllerEnabled;
/** Open a certain Scringo Link Chat Room.

 Open a certain Scringo Link Chat Room. How it should appear and what type of navigation will it have depends on the given arguments.
 The chat Room will be created if it doesn't exist already.
 @param link The URL of the Link to open the Chat Room with.
 @param title The title to show in the Chat Rooom. Will be used only if chat room doesn't already exist.
 @param navController The navigation controller to which Scringo's Chat Room will be pushed. If nil, Scringo's Chat Room will present as MODAL.
 @param scringoNavControllerEnabled Whether to enable Scrigno's navigation bar or not.
 @see getChatRoomTopics
 */
+(void)openChatRoomWithLink:(NSString *)link withTitle:(NSString *)title withNavigationController:(UINavigationController *)navController withScringoNavControllerEnabled:(BOOL)scringoNavControllerEnabled;
/** Open a certain Scringo Text based Chat Room.

 Open a certain Scringo Text based Chat Room. How it should appear and what type of navigation will it have depends on the given arguments.
 The chat Room will be created if it doesn't exist already.
 @param objectId The Id to identify the Chat Room with.
 @param title The title to show in the Chat Rooom. Will be used only if chat room doesn't already exist.
 @param text The text to show in the Chat Room. Will be used only if chat room doesn't already exist.
 @param navController The navigation controller to which Scringo's Chat Room will be pushed. If nil, Scringo's Chat Room will present as MODAL.
 @param scringoNavControllerEnabled Whether to enable Scrigno's navigation bar or not.
 @see getChatRoomTopics
 */
+(void)openChatRoomWithText:(NSString *)objectId withTitle:(NSString *)title withText:(NSString *)text withNavigationController:(UINavigationController *)navController withScringoNavControllerEnabled:(BOOL)scringoNavControllerEnabled;
/** Open a certain Scringo HTML Chat Room.

 Open a certain Scringo HTML Chat Room. How it should appear and what type of navigation will it have depends on the given arguments.
 The chat Room will be created if it doesn't exist already.
 @param objectId The Id to identify the Chat Room with.
 @param title The title to show in the Chat Rooom. Will be used only if chat room doesn't already exist.
 @param html The HTML to show in the Chat Room. Will be used only if chat room doesn't already exist.
 @param navController The navigation controller to which Scringo's Chat Room will be pushed. If nil, Scringo's Chat Room will present as MODAL.
 @param scringoNavControllerEnabled Whether to enable Scrigno's navigation bar or not.
 @see getChatRoomTopics
 */
+(void)openChatRoomWithHtml:(NSString *)objectId withTitle:(NSString *)title withHtml:(NSString *)html withNavigationController:(UINavigationController *)navController withScringoNavControllerEnabled:(BOOL)scringoNavControllerEnabled;

/** Open a certain Scringo Tweet Chat Room.

 Open a certain Scringo Tweet Chat Room. How it should appear and what type of navigation will it have depends on the given arguments.
 The chat Room will be created if it doesn't exist already.
 @param objectId The Id to identify the Chat Room with.
 @param title The title to show in the Chat Rooom. Will be used only if chat room doesn't already exist.
 @param imageUrl The URL of the image to show in the Chat Room. Will be used only if chat room doesn't already exist.
 @param navController The navigation controller to which Scringo's Chat Room will be pushed. If nil, Scringo's Chat Room will present as MODAL.
 @param scringoNavControllerEnabled Whether to enable Scrigno's navigation bar or not.
 @see getChatRoomTopics
 */
+(void)openChatRoomWithTweet:(NSString *)objectId withTitle:(NSString *)title withImageUrl:(NSString *)imageUrl withNavigationController:(UINavigationController *)navController withScringoNavControllerEnabled:(BOOL)scringoNavControllerEnabled;

+(void)openChatRoomWithTopic:(ScringoChatRoom *)topic withNavigationController:(UINavigationController *)navController withScringoNavControllerEnabled:(BOOL)scringoNavControllerEnabled;
...
/** Get App Leading Color.
 
 Get the App Leading Color as configured by the developer.
 @return App Leading Color.
 */
+(UIColor *)leadingColor;

+(NSTimeInterval) getServerTimeDiff:(NSDate *)time;
...
/** Define a the set of badged users.
 
 Define a set of users to which a given badge should be assigned. Two size badges should be handed - small and medium.
 
 @param users Array of users to use badge on.
 @param smallBadge Image of small badge to be placed on user's small image (e.g. activity).
 @param mediumBadge Image of medium badge to be placed on user's medium image (e.g. chats list).
 @param largeBadge Image of large badge to be placed on user's large image (e.g. profile).
 */
+(void)setBadgedUsers:(NSArray *)users withSmallBadge:(UIImage *)smallBadge withMediumBadge:(UIImage *)mediumBadge withLargeBadge:(UIImage *)largeBadge;

/** Set the current user tags.

 Define a set of tags and set them to the current user.

 @param tags Array of tags.
 */
+(void)setUserTags:(NSArray *)tagsArray;
